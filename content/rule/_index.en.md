...
name|value|Notes
---|---|---
Expansion:CurrentExpansion|0|The current expansion enabled for the server [-1 = ALL, 0 = Classic, 1 = Kunark etc.]
...
AA:ModernAAScalingStartPercent|1000.0000000000000|1000% or 10x AA experience at the start of the scaling range
...
Adventure:DistanceForRescueAccept|10000.0000000000000|Distance for adventure rescue accept
Adventure:DistanceForRescueComplete|2500.0000000000000|Distance for adventure rescue complete
...
Adventure:LDoNBaseTrapDifficulty|15.0000000000000|LDoN base trap difficulty
Adventure:LDoNCriticalFailTrapThreshold|10.0000000000000|LDoN critical fail trap threshold
...
Adventure:NumberKillsForBossSpawn|40|Number of adventure kills to make the boss spawn
...
Aggro:IntAggroThreshold|20|Int lesser or equal the value will aggro regardless of level difference
...
Aggro:MeleeRangeAggroMod|20|Aggro increase against targets in melee range. 10=10%
...
Character:HeroicIntelligenceIncreaseSpellDmgMultiplier|0.0000000000000|Allows Heroic Intelligence to increase a Players Worn Spell Damage Stat from Equipment, for example, setting this rule to 1.00 will always grant 1 Spell Damage per 1 Heroic Intelligence
...
Merchant:SellCostMod|1.0499999523163|Modifier for NPC sell price
